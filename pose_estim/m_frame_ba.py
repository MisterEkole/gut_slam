...
def main():
    ...
    for frame_idx, image in enumerate(frames):
        ...
        if frame_idx == 0:
            initial_deformation_strength = 5
            initial_deformation_frequency = 5
            initial_lamda_ortho = 1
            initial_lamda_det = 1
        else:
        ...
        initial_params = np.hstack([rotation_matrix.flatten(), translation_vector.flatten(), initial_deformation_strength, initial_deformation_frequency,initial_lamda_ortho, initial_lamda_det])
