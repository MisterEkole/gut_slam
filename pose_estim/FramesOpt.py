...
def process_frame(image, intrinsic_matrix, initial_params, points_3d, k, g_t, gamma, b_mesh_deformation, frame_idx,control_points):
    ...
    optimized_params = optimize_params(points_3d, points_2d_observed, image, intrinsic_matrix, initial_params, k, g_t, gamma, b_mesh_deformation,control_points)
...
def main():
    ...
    start_frame_idx=500 #choose desired start index for frame default is 0 for 
    total_optim_time = 0
